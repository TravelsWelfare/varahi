        ...
        >
          <div className="max-w-3xl">
            <motion.div 
              ...
              className="inline-block bg-primary/90 backdrop-blur-sm rounded-lg px-4 py-1.5 mb-6 shadow-lg"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white leading-tight mb-6 drop-shadow-2xl"
            >
            ...
            <motion.p 
              ...
              className="text-xl text-white/90 mb-8 max-w-2xl drop-shadow-lg font-light"
            >
            ...
            >
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg transform transition-all hover:scale-105 shadow-xl"
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 1 }}
              className="mt-12 grid grid-cols-2 md:grid-cols-5 gap-4 text-white"
            >
...
const TrustBadge = ({ icon, text }: { icon: React.ReactNode; text: string }) => (
  <motion.div 
    ...
    className="flex flex-col items-center text-center backdrop-blur-sm bg-white/10 rounded-lg p-3 border border-white/20 shadow-lg transition-all hover:bg-white/15"
  >
